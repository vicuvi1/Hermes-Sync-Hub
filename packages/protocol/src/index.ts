...
export const IPC_CHANNELS = {
  ...
  GET_VAULT_STATUS: 'hermes-hub:get-vault-status',
  SETUP_SHARED_VAULT: 'hermes-hub:setup-shared-vault',
  UNLOCK_SHARED_VAULT: 'hermes-hub:unlock-shared-vault',
  LOCK_SHARED_VAULT: 'hermes-hub:lock-shared-vault',
  CHANGE_VAULT_PASSWORD: 'hermes-hub:change-vault-password',
  GET_VAULT_ENVIRONMENTS: 'hermes-hub:get-vault-environments',
  GET_VAULT_ENVIRONMENT: 'hermes-hub:get-vault-environment',
  SAVE_VAULT_ENVIRONMENT: 'hermes-hub:save-vault-environment',
  DELETE_VAULT_ENVIRONMENT: 'hermes-hub:delete-vault-environment',
  CREATE_MIGRATION_BUNDLE: 'hermes-hub:create-migration-bundle',
  IMPORT_MIGRATION_BUNDLE: 'hermes-hub:import-migration-bundle',
  GET_ACTIVITY: 'hermes-hub:get-activity',
  SEARCH_ALL: 'hermes-hub:search-all',
  REINDEX_SEARCH: 'hermes-hub:reindex-search',
  GET_SEARCH_INDEX_STATUS: 'hermes-hub:get-search-index-status',
  SEARCH_INDEX_STATUS: 'hermes-hub:search-index-status',
  SAVE_SEARCH: 'hermes-hub:save-search',
  DELETE_SAVED_SEARCH: 'hermes-hub:delete-saved-search',
  GET_RECOVERY_ARTIFACTS: 'hermes-hub:get-recovery-artifacts',
  RESTORE_RECOVERY_ARTIFACT: 'hermes-hub:restore-recovery-artifact',
